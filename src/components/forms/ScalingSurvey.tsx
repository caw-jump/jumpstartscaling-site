                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <select {...register("role", { required: true })} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-accent focus:outline-none focus:bg-white/10 transition text-white">
                                    <option value="" className="bg-[#1A1A1F] text-white">Select...</option>
                                    <option value="Founder/CEO" className="bg-[#1A1A1F] text-white">Founder/CEO</option>
                                    <option value="Marketing Lead" className="bg-[#1A1A1F] text-white">Marketing Lead</option>
                                    <option value="Sales Lead" className="bg-[#1A1A1F] text-white">Sales Lead</option>
                                    <option value="Product" className="bg-[#1A1A1F] text-white">Product</option>
                                    <option value="Other" className="bg-[#1A1A1F] text-white">Other</option>
                                </select>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <select {...register("currentRevenue", { required: true })} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-accent focus:outline-none text-white">
                                        <option value="" className="bg-[#1A1A1F] text-white">Select...</option>
                                        <option value="0-100k" className="bg-[#1A1A1F] text-white">&lt; $100k</option>
                                        <option value="100k-500k" className="bg-[#1A1A1F] text-white">$100k - $500k</option>
                                        <option value="500k-1m" className="bg-[#1A1A1F] text-white">$500k - $1M</option>
                                        <option value="1m-5m" className="bg-[#1A1A1F] text-white">$1M - $5M</option>
                                        <option value="5m-10m" className="bg-[#1A1A1F] text-white">$5M - $10M</option>
                                        <option value="10m+" className="bg-[#1A1A1F] text-white">$10M+</option>
                                    </select>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select {...register("teamSize", { required: true })} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-accent focus:outline-none text-white">
                                        <option value="" className="bg-[#1A1A1F] text-white">Select...</option>
                                        <option value="1-5" className="bg-[#1A1A1F] text-white">1-5</option>
                                        <option value="6-20" className="bg-[#1A1A1F] text-white">6-20</option>
                                        <option value="21-50" className="bg-[#1A1A1F] text-white">21-50</option>
                                        <option value="50+" className="bg-[#1A1A1F] text-white">50+</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <select {...register("marketingSpend", { required: true })} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-accent focus:outline-none text-white">
                                    <option value="" className="bg-[#1A1A1F] text-white">Select...</option>
                                    <option value="0-5k" className="bg-[#1A1A1F] text-white">&lt; $5k</option>
                                    <option value="5k-20k" className="bg-[#1A1A1F] text-white">$5k - $20k</option>
                                    <option value="20k-50k" className="bg-[#1A1A1F] text-white">$20k - $50k</option>
                                    <option value="50k-100k" className="bg-[#1A1A1F] text-white">$50k - $100k</option>
                                    <option value="100k+" className="bg-[#1A1A1F] text-white">$100k+</option>
                                </select>
